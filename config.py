...
API_ID = int(getenv("API_ID", "20937722"))
API_HASH = getenv("API_HASH", "b64fed7bd8d6ae5d5909c8472783f603")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("7010022450:AAEixXqUCOTJSkH3GiX8JSkvJEJRRbXjjL4", None)

# Get your mongo url from cloud.mongodb.com
MONGO_DB_URI = getenv("mongodb+srv://Unknown:Unknown@unknown.2qz5dea.mongodb.net/?retryWrites=true&w=majority&appName=Unknown", None)

DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 180))

# Chat id of a group for logging bot's activities
LOGGER_ID = int(getenv("-1002158639980", None))

# Get this value from @FallenxBot on Telegram by /id
OWNER_ID = int(getenv("1266240012", "6203163206"))
